...
enum State
{
	pA1, pB1, pB2, pC1, pC2, pC3, pD1, pE1, pE2, pF1, pF2, pG1, pZ1, pEXIT, pLAST_STATE
};


typedef void(ProductionLexer::*production_lexer_method)(TransliteratorToken);
class ProductionLexer
{
	...
	std::vector<std::vector<production_lexer_method>> fsm_table;
	//fsm methods
